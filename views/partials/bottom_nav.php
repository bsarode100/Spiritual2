...
// On single profile detail view or active chat conversation, dedicated action/input bar takes over the bottom bar
if (preg_match('#^/(member|messages)/\d+#', $currentUri)) {
    return;
}
?>
